...
contract MyGovernorTest is Test {
    ...
    function testGovernanceUpdatesBox() public {
        ...
        // propose to the DAO
        uint256 proposalId = governor.propose(target, values, calldatas, description);
        ...
        string memory reason = "because Cricket and Football are the best sports";
        uint8 voteWay = 1; //voting yes = 1, no = 2
